...
const ChatLayout = ({ children }) => {
    ...
    const [firstSelection, setFirstSelection] = useState(true); // New state variable
    ...
    useEffect(() => {
        if (containerRef.current) {
            console.log("Scrolling to bottom:", containerRef.current.scrollHeight);
    ...
    }, [children, selectedConversation]); // Ensure it runs on `children` and `selectedConversation` changes
