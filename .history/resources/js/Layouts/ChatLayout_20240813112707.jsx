...
const ChatLayout = ({ children }) => {
    ...
    useEffect(() => {
        ...
        setIsInitialLoad(true); // Trigger initial load logic
    }, [conversations]);
    ...
    useEffect(() => {
        if (messagesContainerRef.current && isInitialLoad) {
            // Scroll to the bottom on initial load or when a new conversation is selected
            ...
            setIsInitialLoad(false); // Reset flag after initial load
        }
