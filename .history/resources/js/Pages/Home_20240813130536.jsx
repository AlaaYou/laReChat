...
function Home({ selectedConversation = null, messages = null }) {
    ...
    useEffect(() => {
        if (messagesCtrRef.current) {
            // Ensure that the scroll happens after the content has rendered
    ...
    }, [selectedConversation, children]); // Ensure this runs when `selectedConversation` or `children` changes
