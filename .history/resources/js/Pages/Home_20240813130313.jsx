...
function Home({ selectedConversation = null, messages = null }) {
    ...
    useEffect(() => {
        // Scroll to the bottom with a slight delay, if necessary
        ...
        // Handle event listener for 'message.created'
        const OffCreated = on('message.created', messageCreated);
    
        // Reset scroll offset and disable the 'no more messages' flag
        ...
        return () => {
            ...
            OffCreated(); // Remove the event listener when the component unmounts or when `selectedConversation` changes
        };
