...
function Home({ selectedConversation = null, messages = null }) {
    ...
    useEffect(() => {
        // Ensure messages are scrolled to the bottom on mount or when a new message is added
    ...
    useEffect(() => {
        // Update local messages when the selected conversation or initial messages change
