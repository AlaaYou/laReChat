...
function Home({ selectedConversation = null, messages = null }) {
    ...
    const messageCreated = (message) => {
        if (selectedConversation) {
            ...
            if (isRelevantGroup || isRelevantUser) {
                ...
                setMessageSent(true); // Set messageSent to true when a new message is created
            }
        }
    };
    ...
    useEffect(() => {
        ...
        setMessageSent(false); // Reset messageSent when messages change
    }, [messages]);
            ...
            {messages && (
                <>
                    ...
                    <div ref={messagesCtrRef} className="flex-1 overflow-y-auto p-5">
                        {localMessages.length === 0 && !messageSent && (
                        ...
                        {localMessages.length > 0 && (
                            <div className="flex-1 flex flex-col">
                                ...
                                {localMessages.map((message, index) => (
                                    <div key={`${message.id}-${index}`} ref={index === localMessages.length - 1 ? lastMessageRef : null}>
