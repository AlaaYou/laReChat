                            ...
                            <div className="relative group h-full">
                                {currentIndex > 0 && (
                                    <div
                                        ...
                                        justify-center w-16 h-16 left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 z-30"
                                    >
                                ...
                                {currentIndex < previewableAttachments.length -1 && (
                                    <div
                                        onClick={prev}
                                        lassName="absolute opacity-100 text-gray-100 cursor-pointer flex items-center
