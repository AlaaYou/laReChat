export default function ApplicationLogo(props) {
    return (
        <svg {...props} viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M120 120l60 60-60 60" stroke="#333" stroke-width="25" stroke-linecap="round" />
            <path d="M230 120l-60 60 60 60" stroke="#333" stroke-width="25" stroke-linecap="round" />
            <path d="M120 230l60-60-60-60" stroke="#333" stroke-width="25" stroke-linecap="round" />
            <path d="M230 230l-60-60 60-60" stroke="#333" stroke-width="25" stroke-linecap="round" />
        </svg>
    );
}