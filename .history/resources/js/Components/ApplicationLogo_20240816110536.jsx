export default function ApplicationLogo(props) {
    return (
        <svg {...props} viewBox="0 0 1000 900" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M500 450l-150 150 150 150" stroke="#333" strokeWidth="60" strokeLinecap="round" />
            <path d="M500 550l-150-150 150-150" stroke="#333" strokeWidth="60" strokeLinecap="round" />
        </svg>
    );
}