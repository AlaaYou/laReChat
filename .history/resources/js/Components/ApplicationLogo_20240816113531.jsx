export default function ApplicationLogo(props) {
    return (
        <svg {...props} viewBox="0 0 1000 900" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="350" y="350" textAnchor="middle" dominantBaseline="central" fontSize="100" fill="#fff">L</text>
            <text x="650" y="350" textAnchor="middle" dominantBaseline="central" fontSize="100" fill="#fff">L</text>
        </svg>
    );
}
