export default function ApplicationLogo(props) {
    return (
        <svg {...props} viewBox="0 0 1000 900" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="350" y="350" textAnchor="middle" dominantBaseline="central" fontSize="50" fill="#333">L</text>
            <text x="650" y="350" textAnchor="middle" dominantBaseline="central" fontSize="50" fill="#333">L</text>
        </svg>
    );
}
