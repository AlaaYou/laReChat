    ...
    return (
        <svg {...props} viewBox="0 0 1000 900" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="900" height="900" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="500" cy="380" r="200" fill="#4040FF" />
    
   
                <text x="520" y="400" font-family="Arial" font-size="300" fontFamily="Times New Roman" fill="#fff" text-anchor="middle" alignment-baseline="middle">
                     L
                </text>
            </svg>
